...
using sipetra.Models;  // ← PASTIKAN INI ADA
...
namespace sipetra.Views.User
{
    public partial class DetailTransaksiWd : Form
    {
        ...
        public DetailTransaksiWd(UserModel user, string idTransaksi, string tanggal, string jenisTiket, int jumlah, string totalBayar, string status) : this()
        {
            _currentUser = user;
        ...
        public DetailTransaksiWd(UserModel user) : this()
        {
            _currentUser = user;
        }
