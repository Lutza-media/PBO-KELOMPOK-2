...
namespace sipetra.Views
{
    public partial class DetailTransaksiWy : Form
    {
        ...
        // ============================================================
        public DetailTransaksiWy(User user, string idTransaksi, string tanggal, string jenisTiket, int jumlah, string totalBayar, string status) : this()
        {
            _currentUser = user;
        ...
        // ============================================================
        public DetailTransaksiWy(User user) : this()
        {
            _currentUser = user;
        }
