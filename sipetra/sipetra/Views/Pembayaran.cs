...
namespace sipetra.Views
{
    public partial class Pembayaran : Form
    {
        ...
        public Pembayaran(User user, string jenisTiket, int jumlah, int hargaSatuan) : this()
        {
            _currentUser = user;
        ...
        {
            // Tampilkan data di Ringkasan Pesanan
        ...
        // ============================================================
        // TOMBOL KONFIRMASI PEMBAYARAN - INI YANG AKAN MENYIMPAN DATA
        // ============================================================
        private void btnKonfirmasiPembayaran_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // 3. Tampilkan konfirmasi sebelum menyimpan
                ...
                if (berhasil)
                {
                    ...
                    // 7. Navigasi ke halaman Transaksi
