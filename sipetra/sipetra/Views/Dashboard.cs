    ...
    public partial class Dashboard : Form
    {
        ...
        private void LoadDataTiket(string searchText = "")
        {
            try
            {
                ...
                // ============================================================
                // TAMBAHKAN SEMUA KOLOM - TERMASUK TOTAL HARGA
                // ============================================================
                ...
                _dataTableTiket.Columns.Add("Total Harga", typeof(string));  // ✅ WAJIB ADA!
                ...
                SELECT 
                    ...
                    t.jenis_tiket,
                    t.jumlah,
                    t.total_harga,  -- ✅ AMBIL TOTAL HARGA DARI DATABASE
                    t.status,
        ...
        // ============================================================
        // EVENT: TEXTBOX ENTER (Saat focus) - TAMBAHKAN INI!
        // ============================================================
        ...
        // ============================================================
        // EVENT: TEXTBOX LEAVE (Saat kehilangan focus) - TAMBAHKAN INI!
        // ============================================================
        ...
        private void dataGridViewTiket_CellClick(object? sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                string namaPelanggan = selectedRow.Cells["Nama Pelanggan"].Value?.ToString() ?? ""; // <-- AMBIL NAMA

                if (_currentUser == null) return;

                // Buat user baru dengan nama pelanggan
                User userPelanggan = new User();
                ...
                if (jenisTiket.ToLower().Contains("weekend"))
                {
                    DetailTransaksiWy detail = new DetailTransaksiWy(
                        userPelanggan,  // <-- PAKAI USER DENGAN NAMA PELANGGAN
                        idTiket,
                        tanggal,
                        jenisTiket,
                        jumlah,
        ...
        // ============================================================
        // METHOD AMBIL NAMA PELANGGAN DARI DATABASE
        // ============================================================
        private string GetNamaPelangganFromDatabase(string idTiket)
        {
            try
            {
                string idString = idTiket.Replace("TIK-", "");
                int transaksiId = Convert.ToInt32(idString);
            ...
            {
                Console.WriteLine($"Error GetNamaPelanggan: {ex.Message}");
            }
