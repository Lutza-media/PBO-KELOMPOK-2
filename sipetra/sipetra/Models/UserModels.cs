...
{
    public class UserModel  // ← NAMA DIUBAH DARI User MENJADI UserModel
    {
        // ============================================================
        // FIELD PRIVATE
        // ============================================================
        ...
        public bool Register()
        {
            using (var conn = DatabaseHelper.GetConnection())
            {
                ...
                string query = "INSERT INTO users (nama, email, katasandi, is_admin) VALUES (@nama, @email, @password, @is_admin)";
